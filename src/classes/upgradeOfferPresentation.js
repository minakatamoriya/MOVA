const LEVEL_DESC_BY_ID = {
  ...
  archer_volley: [
    '箭矢齐射强化至 5 列散射，这是第一段明显质变。',
    '不增加箭数，改为收束散射角并强化弹道质量，侧箭更稳定。',
    '箭矢齐射强化至 7 列散射，形成后期成型箭幕。'
  ],
  archer_nimble_evade: [
  ...
  mage_shatter: [
    '强化基础碎冰：半径 120，伤害 70%，仍传染 1 层寒霜。',
    '强化基础碎冰：半径 150，伤害 100%，仍传染 1 层寒霜。',
    '强化基础碎冰：半径 185，伤害 135%，传染提升为 2 层寒霜。'
  ],
  mage_frost_nova: [
    '生命低于30%时自动触发：释放冰霜新星，冻结周围敌人 3 秒。',
    '生命低于30%时自动触发：释放冰霜新星，冻结周围敌人 5 秒。',
    '生命低于30%时自动触发：释放冰霜新星，冻结周围敌人 10 秒。'
  ],
  mage_frost_domain: [
    '强化冰霜新星：范围提升至 300。',
    '强化冰霜新星：范围提升至 380。',
